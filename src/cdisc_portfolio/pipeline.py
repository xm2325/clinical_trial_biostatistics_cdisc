...
def run(root: Path) -> dict[str, object]:
    ...
    adqs_actot = derive_actot_adqs_style(qs, adsl)
    efficacy_descriptive = actot_descriptive(adqs_actot)
    efficacy_lsmeans, efficacy_contrasts, ancova_subjects = actot_week24_ancova(adqs_actot)
    ...
    out_paths: dict[str, Path] = {
        ...
        "adqs_actot_style": output_dir / "adqs_actot_style.csv",
    ...
    adqs_actot.to_csv(out_paths["adqs_actot_style"], index=False)
    ...
    all_tables = {
        **safety_tables,
        "table8_actot_descriptive": efficacy_descriptive,
        "table9_actot_lsmeans": efficacy_lsmeans,
        "table10_actot_ancova_contrasts": efficacy_contrasts,
    }
    ...
    efficacy_qc = run_efficacy_qc(adqscibc, adqs_actot, reference_metrics, ancova_subjects).assign(area="efficacy")
    ...
    metrics = {
        ...
        "actot_observed_week24_subjects": obs_n,
        "actot_locf_subjects": locf_n,
    ...
    note = (
        ...
        f"- ACTOT Week 24 ANCOVA subjects: observed={obs_n}; LOCF sensitivity={locf_n}.\n"
